defmodule Imager do
    ...
    # Code for article https://zohaib.me/binary-pattern-matching-in-elixir/
    ...
    def png_parse(<<
        ...
        width::size(32),
        height::size(32),
        bit_depth, color_type, compression_method, filter_method, interlace_method, _crc::size(32), chunks::binary>>) do
        png = %Imager{
            width: width,
            height: height,
            bit_depth: bit_depth,
